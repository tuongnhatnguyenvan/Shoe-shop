// const leftText = document.querySelector('.left-text'); //lấy phần tử class left-text
...
//     leftRow.style.display = 'flex';  //hiển thị phần tử theo chiều ngang
//     rightRow.style.display = 'none';  // ẩn
...
leftText.addEventListener('click', function () {
    ...
    fetch(productsApi)
        ...
        .then((products) => {
            ...
            const filteredProducts = products.filter(product => (product.gender === 'women' || product.gender === 'unisex') && product.category === 'fashion');
...
rightText.addEventListener('click', function () {
    ...
    fetch(productsApi)
        ...
        .then((products) => {
            ...
            const filteredProducts = products.filter(product => (product.gender === 'women' || product.gender === 'unisex') && product.category === 'sport');
...
fetch(productsApi)
    ...
    .then((products) => {
        ...
        const filteredProducts = products.filter(product => product.gender === 'women' || product.gender === 'unisex');
